...
def get_current_user_id(authorization: Optional[str] = Header(None),) -> int:
    """
    Securely extracts user_id from Authorization: Bearer <token>
    Used by any authenticated endpoint (profile, pace, tts_rate, progress, etc.)
    """
